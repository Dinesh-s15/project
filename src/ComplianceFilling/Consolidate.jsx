...
// import data from './ConsolidateData'
// import columns from './ConsolidateColumns'
...
//                             <button><HiOutlineDownload onClick={() => setShow(!show)} className='rounded-full w-9 h-9 p-2 mt-0.5 text-white' style={{ backgroundColor: '#D7B95F' }} /> </button>
//                             {show && <div className='absolute z-30 bg-white rounded-md shadow border border-gray-600  right-0 w-28 text-center text-md p-2 h-14'>
//                                 <span onClick={downloadCSV} className='hover:bg-gray-100  hover:cursor-pointer'>download CSV</span><br />
//                                 <span onClick={downloadpdf} className='hover:bg-gray-100  hover:cursor-pointer'>download PDF</span><br />
//                             </div>}
//                         </div>
//                     </div>
//                 </div>

//                 <div className=' grid  grid-cols-1   lg:grid-cols-5  m-2 gap-2 '>
//                     <div onClick={(e) => setSelectValue({ ...selectValue, Status: '' })} className=' relative overflow-hidden h-36 pt-1 pe-1 bg-fuchsia-100 rounded-lg border-l-8 border-fuchsia-600  hover:border-4 hover:ps-1 hover:pt-0 hover:pe-0 hover:border-fuchsia-500'>
...
//                         </div>
//                     </div>
//                     <div onClick={(e) => setSelectValue({ ...selectValue, Status: 'Complied' })} className='relative overflow-hidden h-36 pt-1 pe-1 bg-green-100 rounded-lg border-l-8 border-green-600  hover:border-4  hover:ps-1 hover:pt-0 hover:pe-0 hover:border-green-500'>
...
//                     </div>
//                     <div onClick={(e) => setSelectValue({ ...selectValue, Status: 'Not Complied' })} className='relative overflow-hidden h-36 pt-1 pe-1 bg-red-100 rounded-lg border-l-8 border-red-600  hover:border-4  hover:ps-1 hover:pt-0 hover:pe-0 hover:border-red-500'>
...
//                         </div>
//                     </div>
//                     <div onClick={(e) => setSelectValue({ ...selectValue, Status: 'Partially Complied' })} className='relative overflow-hidden h-36 pt-1 pe-1 bg-yellow-100 rounded-lg border-l-8 border-yellow-600  hover:border-4  hover:ps-1 hover:pt-0 hover:pe-0 hover:border-yellow-500'>
...
//                         </div>
//                     </div>
//                     <div onClick={(e) => setSelectValue({ ...selectValue, Status: 'Over Due' })} className='relative overflow-hidden h-36 pt-1 pe-1  bg-orange-100 rounded-lg border-l-8 border-orange-500  hover:border-4  hover:ps-1 hover:pt-0 hover:pe-0 hover:border-orange-500'>
...
//                 <div id='print-section' className='grid grid-cols-1 w-full gap-2 lg:grid-cols-9 px-5 pb-4' >
...
//                     data={filterdata} >
//                 </DataTable>
//                 <div className='lg:flex lg:justify-between items-center w-auto flex-row justify-center py-2 '>
//                     <select value={Itemsperpage} onChange={(e) => setItemsPerPage(e.target.value)} className=' m-5 py-2  rounded w-28 items-center justify-center'>
